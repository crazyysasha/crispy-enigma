<script setup>
import MessageFallowers from './minicomponents/Message-Fallowers.vue';
import MessagePeople from './minicomponents/Message-People.vue';
import MessageChat from './minicomponents/MessageChat.vue';
</script>
    ...
    <header>
        <div class="flex flex-col">
            <div class="flex justify-between border-2 p-8">
                <div>
                    <h1 class="text-[24px] font-bold">Message</h1>
                </div>
                <div class="flex gap-8">
                    <button> <img src="src/assets/images/Dashboardpictures/Notification.png" alt="" class="w-8"></button>
                    <img src="src/assets/images/Dashboardpictures/Profil.png" alt="" class="w-16">
                </div>
            </div>
            <div class="border-2 p-8  flex flex-col gap-6 ">
                <div class="flex flex-row">
                    <div class="flex flex-col gap-[30px]">
                        ...
                        <MessageFallowers name="Angelie Crison" comment="Thank you very much. I’m glad ..." lastseen="1 m Ago">
                            <img src="src/assets/images/Messagepictures/AngelieCrison.png" alt=""  class="w-[48px] aspect-square">
                        </MessageFallowers>
