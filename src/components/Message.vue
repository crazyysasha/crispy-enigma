...
<template>
    <header>
        ...
        <div class="flex justify-between border-2 p-8 rounded-xl">
            <div>
        ...
        <div class="border-2 p-8 rounded-xl flex flex-col gap-6 ">
            <div class="rounded-xl border-2 flex items-center">
