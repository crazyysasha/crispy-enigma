<script setup></script>
<template>
    <div class="flex flex-col justify-between p-8 w-80 h-[93.6vh]">
        <a href="" class="flex items-center text-4xl font-semibold gap-1">
        ...
        <nav class="flex flex-col gap-2 w-52"><a href="" class="flex font-medium gap-1 py-5 px-5 bg-[#F5F5F7] rounded-xl"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
            ...
            <a href="" class="flex font-medium gap-1 py-5 px-5"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    viewBox="0 0 24 24" fill="none">
                    <path
    ...
    <div class="w-50 h-55 flex flex-col gap-6 items-center justify-around bg-[#141522] text-white border rounded-xl pb-[20px]">
        <div><img src="../assets/Question.png" alt=""></div>
        <div class="flex flex-col gap-1 items-center w-[200px] h-[44px]"><div class="text-base/8 font-semibold">Help Center</div>
    <div>Having Trouble in Learning. Please contact us for more questions.</div></div>
    <div class="pt-[112px]"><div class="py-3 px-3 bg-white text-black text-lg/normal rounded-xl"><a href="">Go To Help Center</a></div></div>
    </div>
</div></template>